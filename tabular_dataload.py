...
def get_dataset(FLAGS, evaluation=False):
    ...
    full_negative_con = pd.read_csv(
        "/home/graph_data/negative_continuous_Phishing1_80000.csv").to_numpy()
    full_negative_dis = pd.read_csv(
        "/home/negative_discrete_Phishing1_80000.csv").to_numpy()
    full_negative_con=full_negative_con[:, :0]
    full_negative_dis=full_negative_dis[:, 0:]
